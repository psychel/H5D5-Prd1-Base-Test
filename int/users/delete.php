<?php include "../inc/cdbinfo.inc"; ?><style>
<?php include "../admincheck.php"; ?></style>
<html>
<body>
...
<!-- Input form -->
  ...
  <table border="0">
      ...
      <tr>
		<td>
                    <p> Click on the user you want to delete below then click the button.</p></td><td></tr><tr><td>
		<?PHP echo "<input type='text' name='deluser' maxlength='40' size='40' value='".$user."' />"?></td>
      </tr><tr><td><input type="submit" name="del" value="Delete user" /></td><td></td>
	</tr>
...
while($query_data = mysqli_fetch_row($result)) {
  $Link="<a href='delete.php?ID=$query_data[0]&user=$query_data[1]'>";  
  echo "<tr>";
