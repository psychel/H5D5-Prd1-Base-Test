...
<html>
<body>
<h1>Welcome to the User Administration page - wjqWDedy</h1>
...
<!-- Input form -->
  ...
  <table border="0">
	...
	<td>Change the group for a user: <? echo $LastName?></td><td>
          <input type="text"  />
		<?PHP echo "<input id='search' placeholder='Search' type='text' name='gusername' maxlength='45' size='30' value='" .$user."' />"; ?>
