...
if(isset($_POST['login'])){
    ...
    header('Location: https://demo.darbus.co.uk/');
...
if(isset($_POST['submit']))
{
	...
	{
		$update_password = mysqli_query($db, "UPDATE login SET password = '$new_password' WHERE id = $userID");
		if($update_password)
		{
        	...
        	<form class="form-horizontal" role="form" method="post">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <a href="https://demo.darbus.co.uk">After submitting the change click here:- Login</a>
